...
app.use("/resources/images/store/profile",express.static('resources/images/store/profile'))
app.use("/resources/images/store/cover",express.static('resources/images/store/cover'))

app.use("/resources/images/user/document",express.static('resources/images/user/document'))
app.use("/resources/images/user/profile",express.static('resources/images/user/profile'))

app.use("/resources/images/product",express.static('resources/images/product'))

app.use("/resources/excelfiles",express.static('resources/excelfiles'))

app.use("/resources/template/images",express.static('resources/template/images'))
