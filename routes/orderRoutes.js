...
router.post('/user/instore/own',isAuthenticatedUser,getUSerInstoreOwnOrders)
...
router.post('/users/instore/all',isAuthenticatedStore,getAllUserInStoreOrdersByStoreOwner)
