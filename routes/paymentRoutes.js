...
const { newOrder, getAllUserOrdersByStoreOwner, getSingleOrderDetailByStoreOwner, getUSerOwnOrders, updateUserOrderStatus, getSingleOrderDetailByUser } = require('../controllers/odderController');
...
router.get('/connect-stripe-account/:id', paymentController.connectStripeAccount)
